...
bibliography: ["rversion.bib", "packages.bib"]
...
# tidy data manipulation    
    "purrr", "dplyr", "tibble", "tidyr", "stringr", "cubelyr", "magrittr", 
# plots
...
# documentation and paper
    "knitr", "rmarkdown", "bookdown", "rticles", "kableExtra", "Cairo", "bibtex",
...
# copy bib to vignettes
fs::file_copy(
  fs::path("packages.bib"), 
  fs::path("vignettes/packages.bib"), 
  overwrite = TRUE
  )
fs::file_copy(
...
bibtex::write.bib(rref, "rversion.bib")
```
...
Use the function `pointapply::render_paper()` and specify the directory to save the paper. Make sure to have latex installed on your system. Check e.g., https://yihui.org/tinytex/ for a light weight tex version.
...
Some specialised specialised packages where used, notably; *R.matlab* for loading the matlab LANS files [@R.matlab] and *cubelyr* [@cubelyr] for flattening the 3D arrays, and *MASS* [@MASS; @MASS2002] for 2D density estimates.
