...
This paper assess the performance of the application of the `diag_R()` function of the sister package *point* [@point] in detecting isotope heterogeneity in natural substrates. 
...
The construction of the R [@rversion] package *pointapply* and associated documentation was aided by the packages; *devtools* [@devtools], *roxygen2* [@roxygen2], and *fs* [@fs].
