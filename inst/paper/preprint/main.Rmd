...
tb_dia <- dplyr::left_join(
  ...
  pointapply::diag_64_MON_13C_12C,
  by = "dim_name.nm"
) %>% 
...
tb_dia <- dplyr::left_join(
  ...
  pointapply::diag_64_MEX_13C_12C,
  by = "dim_name.nm"
) %>% 
  dplyr::select(-c(sample.nm, ratio.nm)) %>% 
  dplyr::rename(` ` = "dim_name.nm") 
