...
repo <- tibble::tibble(
  ...
  DOI = c(
    ...
    "\\href{https://doi.org/10.5281/zenodo.4580159}{10.5281/zenodo.4580159}"
    )
)
# print
kableExtra::kable(
...
point::stat_R(map_sum_grid_64_all, "13C", "12C", sample.nm, dim_name.nm, 
              grid.nm, .stat=c("M", "RSeM", "chi2"), .label = "latex") %>% 
