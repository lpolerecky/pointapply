...
# QSA test
test_QSA_64_all <- point::QSA_test(tb, "13C", "12C", file.nm, sample.nm, grid.nm, .nest = grid.nm)
# make mlm model line
test_QSA_64_all <- mutate(test_QSA_64_all, hat_R = alpha_grid.nm + beta_grid.nm * Xt.pr.12C)
```
...
# save data
write_point("test_QSA_64_all", on_build )
 
# save plot  
save_point("point_QSA", last_plot(), width = 12, height = 6, unit = "cm", on_build)
```
...
write_point("stat_R_64_all", on_build)
head(stat_R_64_all)
```
