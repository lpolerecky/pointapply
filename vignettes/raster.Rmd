...
load_point("map_sum_grid", name, 64, return_name = FALSE)
# load ion maps
load_point("map_raster_image", name, return_name = FALSE)
...
```{r raster}
gg_cnts(map_raster_image_MEX, "12C14N", "12C", viri = "D")
# save
