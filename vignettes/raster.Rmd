...
diag_64_MON <- gg_effect(ls_diag, map_raster_image_MON, "MON", "12C-40Ca16O", 
                         viri = "B")
# save plot
save_point("raster_MON_12C-40Ca16O", ggplot2::last_plot(), width = 16, height = 14, 
           unit = "cm", on_build)
# save data
...
# save
save_point("point_MEX_ROI9", ggplot2::last_plot(), width = 9, height = 10, 
           unit = "cm", on_build)
```
...
# save
save_point("point_MEX_ROI2", ggplot2::last_plot(), width = 9, height = 10, 
           unit = "cm", on_build)
```
