...
This vignette deals with the visualization of spatial ion maps and high-precision isotope data generated with the Cameca nanoSIMS 50L, and as discussed in the paper (Figs 7 and 8, and Supplementary Fig. 7). 
...
# save
save_point("simple_raster_Mex_12C-14N-12C", last_plot(), width = 10, height = 8, unit = "cm", on_build = TRUE)
```
...
```{r grid1}
# combination plot
diag_64_MON <- gg_effect(ls_eval, map_raster_image_MON, "MON", "12C-40Ca16O", viri = "B")
# save plot
save_point("raster_MON_12C-40Ca16O", diag_64_MON[[2]], width = 16, height = 14, unit = "cm", on_build)
# save data
diag_64_MON <- diag_64_MON[[1]]
...
diag_64_MEX[[2]] <- diag_64_MEX[[2]] + 
  ggplot2::annotate("rect", xmin = 0, xmax = 64, ymin = 64, ymax = 128, 
           fill = "transparent", color = "red", size = 1)
# save plot
save_point("raster_MEX_12C-40Ca16O", diag_64_MEX[[2]], width = 16, height = 14, unit = "cm", on_build = TRUE)
# save data
diag_64_MEX <- diag_64_MEX[[1]]
...
# rectangle identifying area of in depth analyses  (see below)
gg_MEX_raster2[[2]] <- gg_MEX_raster2[[2]] + 
  ggplot2::annotate("rect", xmin = 128, xmax = 192, ymin = 0, ymax = 64, 
           fill = "transparent", color = "red", size = 1) 
# save
save_point("raster_MEX_12C14N-12C", gg_MEX_raster2[[2]], width = 16, height = 14, unit = "cm", on_build = TRUE)
```
...
# save
save_point("point_MEX_ROI9", last_plot(), width = 12, height = 8, unit = "cm", on_build = TRUE)
```
...
# save
save_point("point_MEX_ROI2", last_plot(), width = 12, height = 8, unit = "cm", on_build = TRUE)
```
