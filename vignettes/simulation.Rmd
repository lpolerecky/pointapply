...
# save and print
save_point("simu_intra_concept", ggplot2::last_plot(), width = 14, height = 7, 
           unit = "cm")
```
...
```{r CD}
# diagnostics
simu_CD_eval_intra <- point::diag_R(simu_sens_IC_intra, "13C", "12C", !!!grps, .X = Xt.sm, .N = N.sm)
# export
...
tb_dia <- point::diag_R(simu_sens_IC_intra , "13C", "12C", !!! grps, bl.nm, 
                        .X = Xt.sm, .N = N.sm, .method = "Cameca", 
                        .output = "diagnostic")
# evaluation of performance (intra-analysis isotope test)
CM_eval <- point::eval_diag(tb_dia, "13C", "12C", !!!grps, .X = Xt.sm, .N = N.sm)
