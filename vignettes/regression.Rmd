...
save_point("bar_QQ_class", QQ_class, width = 7, height = 7, unit = "cm") # save
```
...
save_point("bar_CV_class", CV_class, width = 7, height = 7, unit = "cm") # save
```
...
save_point("bar_mu_class", mu_class, width = 7, height = 7, unit = "cm") # save
```
...
save_point("bar_IR_class", IR_class, width = 7, height = 7, unit = "cm") # save
```
